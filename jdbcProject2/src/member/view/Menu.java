	...
	public void displayMenu() {
		...
		do {
			...
			case 4:
				...
				int Ures = 0;
				Ures = mController.updateMember(member);
				if (Ures > 0) {
					System.out.println("수정이 성공 하였습니다.");
				}
				break;
			case 5:
				...
				int Dres = 0;
				Dres = mController.deleteMember(userId);
				if (Dres > 0) {
	...
	public void searchMeun() {
		...
		do {
			...
			case 4:
				...
				// 결과 값을 하단의 mList에 넣어주세요.
				mList = mController.selectSearchEnrollDate(Date.valueOf(bd), Date.valueOf(ed));
				printList(mList);
				break;
			case 5:
